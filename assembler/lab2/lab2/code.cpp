...
int main()
{
	...
	__declspec(align(16)) const unsigned int n = 3;
	__declspec(align(16)) float in[n*8*8] = {
	...
	__declspec(align(16)) float out2[n*8*8];
	__declspec(align(16)) float out3[n*8*8];
	__declspec(align(16)) float outi2[n*8*8];
	__declspec(align(16)) float outi3[n*8*8];

...
%RSA шифрование
fileOutput = fopen('C:\Users\Charny_Nikcharn\Desktop\ИБ4\text1.txt', 'r');
...
fileInput = fopen('C:\Users\Charny_Nikcharn\Desktop\ИБ4\textShifr.txt', 'w');
fwrite(fileInput, message, 'ubit11');
fclose(fileInput);


%RSA дешифрование
fileOutput = fopen('C:\Users\Charny_Nikcharn\Desktop\ИБ4\textShifr.txt', 'r');
...
fileInput = fopen('C:\Users\Charny_Nikcharn\Desktop\ИБ4\textDeShifr.txt', 'w');
